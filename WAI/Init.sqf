...
on_kill_static = compile preprocessFileLineNumbers "\z\addons\dayz_server\WAI\compile\ai_killed_static.sqf";
on_kill_chopper = compile preprocessFileLineNumbers "\z\addons\dayz_server\WAI\compile\ai_killed_chopper.sqf";
